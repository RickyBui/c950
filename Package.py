...
class Packages:
    def __init__(self, ID, address, city, state, zipcode, Deadline_time, weight, status, departuretime, deliverytime):
        self.ID = ID
    ...
    def __str__(self):
        return "ID:%s, %s, %s, %s, %s, %s, %s, %s, Departured time: %s, Delivered at: %s" % (self.ID, self.address, self.city, self.state, self.zipcode,
